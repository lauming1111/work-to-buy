...
export default function App(): JSX.Element {
  ...
  return (
    <div className={`big-container ${darkMode ? "dark" : "light"}`}>
      ...
      <div className="disclaimer">This website is generated by AI, actual results may vary.

        <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 3 }}>
          Work = Slavery with extra steps
          <br></br>
          <img src={ram} style={{ width: "30%", height: "30%", marginLeft: 4, marginTop: 3, verticalAlign: "middle" }} />
        </div>
